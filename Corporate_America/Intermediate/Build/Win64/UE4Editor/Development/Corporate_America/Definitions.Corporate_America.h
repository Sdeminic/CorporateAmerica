...
#define ORIGINAL_FILE_NAME "UE4Editor-Corporate_America.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME Corporate_America
#define DEPRECATED_FORGAME DEPRECATED
#define CORPORATE_AMERICA_API DLLEXPORT
